...
.field private static x:Landroid/support/transition/s;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/transition/f;->x:Landroid/support/transition/s;
...
.method public a(Landroid/view/ViewGroup;Landroid/support/transition/ap;Landroid/support/transition/ap;)Landroid/animation/Animator;
    ...
    iget-object v2, v0, Landroid/support/transition/ap;->a:Ljava/util/Map;

    .line 117
    move-object/from16 v0, p3

    iget-object v3, v0, Landroid/support/transition/ap;->a:Ljava/util/Map;
    ...
    iget-object v4, v0, Landroid/support/transition/ap;->b:Landroid/view/View;
    ...
    invoke-direct {v2, v0}, Landroid/support/transition/g;-><init>(Landroid/support/transition/f;)V

    .line 220
    move-object/from16 v0, p0

    invoke-virtual {v0, v2}, Landroid/support/transition/f;->a(Landroid/support/transition/ag$b;)Landroid/support/transition/ag;
    ...
    .line 274
    new-instance v2, Landroid/support/transition/h;

    move-object/from16 v0, p0

    invoke-direct {v2, v0}, Landroid/support/transition/h;-><init>(Landroid/support/transition/f;)V
    ...
    .line 302
    :cond_1d
    new-instance v2, Landroid/support/transition/i;

    move-object/from16 v0, p0

    invoke-direct {v2, v0}, Landroid/support/transition/i;-><init>(Landroid/support/transition/f;)V
    ...
    sget-object v5, Landroid/support/transition/f;->x:Landroid/support/transition/s;
    ...
    invoke-direct {v3, v0, v1, v8, v4}, Landroid/support/transition/j;-><init>(Landroid/support/transition/f;Landroid/view/ViewGroup;Landroid/graphics/drawable/BitmapDrawable;Landroid/view/View;)V
...
.method public a(Landroid/support/transition/ap;)V
    ...
    .prologue
    .line 102
    invoke-direct {p0, p1}, Landroid/support/transition/f;->c(Landroid/support/transition/ap;)V
