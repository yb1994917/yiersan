...
.field protected f:Landroid/support/v7/view/menu/t;

.field private g:Landroid/support/v7/view/menu/s$a;
...
.method public a(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/t;
    ...
    .prologue
    .line 77
    iget-object v0, p0, Landroid/support/v7/view/menu/b;->f:Landroid/support/v7/view/menu/t;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/b;->f:Landroid/support/v7/view/menu/t;

    .line 79
    iget-object v0, p0, Landroid/support/v7/view/menu/b;->f:Landroid/support/v7/view/menu/t;

    iget-object v1, p0, Landroid/support/v7/view/menu/b;->c:Landroid/support/v7/view/menu/k;

    invoke-interface {v0, v1}, Landroid/support/v7/view/menu/t;->a(Landroid/support/v7/view/menu/k;)V
...
.method public a(Landroid/support/v7/view/menu/m;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .prologue
    .line 181
    instance-of v0, p2, Landroid/support/v7/view/menu/t$a;

    if-eqz v0, :cond_0

    .line 182
    check-cast p2, Landroid/support/v7/view/menu/t$a;

    move-object v0, p2

    .line 186
    :goto_0
    invoke-virtual {p0, p1, v0}, Landroid/support/v7/view/menu/b;->a(Landroid/support/v7/view/menu/m;Landroid/support/v7/view/menu/t$a;)V
    ...
    .line 184
    :cond_0
    invoke-virtual {p0, p3}, Landroid/support/v7/view/menu/b;->b(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/t$a;
...
.method public a(Landroid/support/v7/view/menu/k;Z)V
    ...
    .prologue
    .line 210
    iget-object v0, p0, Landroid/support/v7/view/menu/b;->g:Landroid/support/v7/view/menu/s$a;
...
.method public abstract a(Landroid/support/v7/view/menu/m;Landroid/support/v7/view/menu/t$a;)V
.end method
...
.method public a(Landroid/support/v7/view/menu/s$a;)V
    ...
    .prologue
    .line 152
    iput-object p1, p0, Landroid/support/v7/view/menu/b;->g:Landroid/support/v7/view/menu/s$a;
...
.method public a(Z)V
    ...
    invoke-virtual {v1}, Landroid/support/v7/view/menu/k;->j()V
    ...
    .line 100
    invoke-virtual {p0, v4, v1}, Landroid/support/v7/view/menu/b;->a(ILandroid/support/v7/view/menu/m;)Z
    ...
    .line 102
    instance-of v2, v3, Landroid/support/v7/view/menu/t$a;

    if-eqz v2, :cond_4

    move-object v2, v3

    check-cast v2, Landroid/support/v7/view/menu/t$a;

    .line 103
    invoke-interface {v2}, Landroid/support/v7/view/menu/t$a;->getItemData()Landroid/support/v7/view/menu/m;

    move-result-object v2

    .line 104
    :goto_1
    invoke-virtual {p0, v1, v3, v0}, Landroid/support/v7/view/menu/b;->a(Landroid/support/v7/view/menu/m;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
...
.method public b(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/t$a;
    .locals 3
...
.method public d()Landroid/support/v7/view/menu/s$a;
    .locals 1
