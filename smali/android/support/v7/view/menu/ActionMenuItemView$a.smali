...
.method public a()Landroid/support/v7/view/menu/w;
    ...
    invoke-virtual {v0}, Landroid/support/v7/view/menu/ActionMenuItemView$b;->a()Landroid/support/v7/view/menu/w;
...
.method protected b()Z
    ...
    iget-object v1, v1, Landroid/support/v7/view/menu/ActionMenuItemView;->b:Landroid/support/v7/view/menu/k$b;
    ...
    iget-object v2, v2, Landroid/support/v7/view/menu/ActionMenuItemView;->a:Landroid/support/v7/view/menu/m;

    invoke-interface {v1, v2}, Landroid/support/v7/view/menu/k$b;->a(Landroid/support/v7/view/menu/m;)Z
    ...
    .line 326
    invoke-virtual {p0}, Landroid/support/v7/view/menu/ActionMenuItemView$a;->a()Landroid/support/v7/view/menu/w;
    ...
    invoke-interface {v1}, Landroid/support/v7/view/menu/w;->f()Z
