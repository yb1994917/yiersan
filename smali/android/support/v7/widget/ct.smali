...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/widget/cu;-><init>(Landroid/support/v7/widget/ct;)V

    iput-object v0, p0, Landroid/support/v7/widget/ct;->c:Landroid/support/v7/widget/RecyclerView$l;
...
.method private b()V
    ...
    .prologue
    .line 113
    iget-object v0, p0, Landroid/support/v7/widget/ct;->a:Landroid/support/v7/widget/RecyclerView;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ct;->c:Landroid/support/v7/widget/RecyclerView$l;
...
.method private b(Landroid/support/v7/widget/RecyclerView$h;II)Z
    ...
    .line 162
    :cond_1
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/ct;->b(Landroid/support/v7/widget/RecyclerView$h;)Landroid/support/v7/widget/bf;
    ...
    .line 167
    invoke-virtual {p0, p1, p2, p3}, Landroid/support/v7/widget/ct;->a(Landroid/support/v7/widget/RecyclerView$h;II)I
...
.method a()V
    ...
    .line 190
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/ct;->a(Landroid/support/v7/widget/RecyclerView$h;)Landroid/view/View;
    ...
    .line 194
    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/ct;->a(Landroid/support/v7/widget/RecyclerView$h;Landroid/view/View;)[I
    ...
    .line 196
    :cond_2
    iget-object v1, p0, Landroid/support/v7/widget/ct;->a:Landroid/support/v7/widget/RecyclerView;
...
.method public a(Landroid/support/v7/widget/RecyclerView;)V
    ...
    .line 98
    invoke-direct {p0}, Landroid/support/v7/widget/ct;->c()V

    .line 100
    :cond_2
    iput-object p1, p0, Landroid/support/v7/widget/ct;->a:Landroid/support/v7/widget/RecyclerView;
    ...
    .line 102
    invoke-direct {p0}, Landroid/support/v7/widget/ct;->b()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ct;->b:Landroid/widget/Scroller;

    .line 105
    invoke-virtual {p0}, Landroid/support/v7/widget/ct;->a()V
...
.method public a(II)Z
    ...
    .line 70
    :cond_1
    iget-object v2, p0, Landroid/support/v7/widget/ct;->a:Landroid/support/v7/widget/RecyclerView;
    ...
    .line 76
    :cond_2
    invoke-direct {p0, v1, p1, p2}, Landroid/support/v7/widget/ct;->b(Landroid/support/v7/widget/RecyclerView$h;II)Z
...
.method protected b(Landroid/support/v7/widget/RecyclerView$h;)Landroid/support/v7/widget/bf;
    .locals 2
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/cv;-><init>(Landroid/support/v7/widget/ct;Landroid/content/Context;)V
...
.method public b(II)[I
    ...
    .line 139
    iget-object v0, p0, Landroid/support/v7/widget/ct;->b:Landroid/widget/Scroller;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ct;->b:Landroid/widget/Scroller;
