...
.method public onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    .prologue
    .line 183
    iget-object v0, p0, Landroid/support/v7/widget/MenuPopupWindow$MenuDropDownListView;->i:Landroid/support/v7/widget/bj;
    ...
    .line 204
    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/j;->a(I)Landroid/support/v7/view/menu/m;
    ...
    .line 211
    invoke-virtual {v0}, Landroid/support/v7/view/menu/j;->a()Landroid/support/v7/view/menu/k;
    ...
    .line 213
    iget-object v3, p0, Landroid/support/v7/widget/MenuPopupWindow$MenuDropDownListView;->i:Landroid/support/v7/widget/bj;

    invoke-interface {v3, v0, v2}, Landroid/support/v7/widget/bj;->a(Landroid/support/v7/view/menu/k;Landroid/view/MenuItem;)V
    ...
    .line 219
    iget-object v2, p0, Landroid/support/v7/widget/MenuPopupWindow$MenuDropDownListView;->i:Landroid/support/v7/widget/bj;

    invoke-interface {v2, v0, v1}, Landroid/support/v7/widget/bj;->b(Landroid/support/v7/view/menu/k;Landroid/view/MenuItem;)V
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v0}, Landroid/support/v7/view/menu/ListMenuItemView;->getItemData()Landroid/support/v7/view/menu/m;

    move-result-object v2

    invoke-virtual {v2}, Landroid/support/v7/view/menu/m;->hasSubMenu()Z
...
.method public setHoverListener(Landroid/support/v7/widget/bj;)V
    .locals 0

    .prologue
    .line 152
    iput-object p1, p0, Landroid/support/v7/widget/MenuPopupWindow$MenuDropDownListView;->i:Landroid/support/v7/widget/bj;
