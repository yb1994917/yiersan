...
# instance fields
.field final A:Landroid/support/v7/widget/RecyclerView$r;
...
.field E:Landroid/support/v7/widget/bx;
...
.field private R:Landroid/support/v7/widget/RecyclerView$k;
...
.field private final aD:Landroid/support/v7/widget/dq$b;
...
.field private ao:Landroid/support/v7/widget/RecyclerView$j;
...
.field final d:Landroid/support/v7/widget/RecyclerView$n;

.field e:Landroid/support/v7/widget/n;

.field f:Landroid/support/v7/widget/ak;

.field final g:Landroid/support/v7/widget/dq;
...
.field n:Landroid/support/v7/widget/RecyclerView$o;
...
.field final x:Landroid/support/v7/widget/RecyclerView$t;

.field y:Landroid/support/v7/widget/bb;

.field z:Landroid/support/v7/widget/bb$a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->d:Landroid/support/v7/widget/RecyclerView$n;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/dq;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->x:Landroid/support/v7/widget/RecyclerView$t;
    ...
    :goto_0
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->z:Landroid/support/v7/widget/bb$a;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->A:Landroid/support/v7/widget/RecyclerView$r;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->aD:Landroid/support/v7/widget/dq$b;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/RecyclerView;->setAccessibilityDelegateCompat(Landroid/support/v7/widget/bx;)V
...
.method private A()Z
    ...
    .line 1657
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->f:Landroid/support/v7/widget/ak;
    ...
    .line 1659
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->f:Landroid/support/v7/widget/ak;

    invoke-virtual {v3, v1}, Landroid/support/v7/widget/ak;->b(I)Landroid/view/View;
    ...
    .line 1663
    :cond_1
    invoke-virtual {v3}, Landroid/support/v7/widget/RecyclerView$u;->x()Z
...
.method private B()V
    ...
    .prologue
    .line 2076
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->x:Landroid/support/v7/widget/RecyclerView$t;
...
.method private C()V
    ...
    .line 2138
    :cond_0
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->ad:Landroid/support/v4/widget/EdgeEffectCompat;
    ...
    .line 2139
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->ae:Landroid/support/v4/widget/EdgeEffectCompat;
    ...
    .line 2140
    :cond_2
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->af:Landroid/support/v4/widget/EdgeEffectCompat;
...
.method private H()V
    ...
    .line 3247
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->e:Landroid/support/v7/widget/n;
    ...
    .line 3259
    :goto_1
    iget-object v4, p0, Landroid/support/v7/widget/RecyclerView;->A:Landroid/support/v7/widget/RecyclerView$r;
    ...
    :goto_2
    iput-boolean v3, v4, Landroid/support/v7/widget/RecyclerView$r;->i:Z

    .line 3266
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->A:Landroid/support/v7/widget/RecyclerView$r;

    iget-object v4, p0, Landroid/support/v7/widget/RecyclerView;->A:Landroid/support/v7/widget/RecyclerView$r;

    iget-boolean v4, v4, Landroid/support/v7/widget/RecyclerView$r;->i:Z
    ...
    :goto_3
    iput-boolean v2, v3, Landroid/support/v7/widget/RecyclerView$r;->j:Z
...
.method private I()V
    ...
    .line 3332
    :cond_0
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/RecyclerView;->d(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView$u;
    ...
    invoke-virtual {v2}, Landroid/support/v7/widget/RecyclerView$u;->g()J

    move-result-wide v0

    :goto_3
    iput-wide v0, v3, Landroid/support/v7/widget/RecyclerView$r;->l:J

    .line 3340
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->A:Landroid/support/v7/widget/RecyclerView$r;
    ...
    .line 3342
    :goto_4
    iput v0, v1, Landroid/support/v7/widget/RecyclerView$r;->k:I

    .line 3343
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->A:Landroid/support/v7/widget/RecyclerView$r;
    ...
    iput v1, v0, Landroid/support/v7/widget/RecyclerView$r;->m:I
    ...
    .line 3341
    :cond_3
    invoke-virtual {v2}, Landroid/support/v7/widget/RecyclerView$u;->q()Z

    move-result v0

    if-eqz v0, :cond_4

    iget v0, v2, Landroid/support/v7/widget/RecyclerView$u;->d:I
...
.method private J()V
    ...
    iput-wide v2, v0, Landroid/support/v7/widget/RecyclerView$r;->l:J

    .line 3349
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->A:Landroid/support/v7/widget/RecyclerView$r;

    iput v1, v0, Landroid/support/v7/widget/RecyclerView$r;->k:I
...
.method private K()Landroid/view/View;
    ...
    iget v0, v0, Landroid/support/v7/widget/RecyclerView$r;->k:I
    ...
    .line 3366
    :goto_0
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView;->A:Landroid/support/v7/widget/RecyclerView$r;
    ...
    .line 3368
    invoke-virtual {p0, v2}, Landroid/support/v7/widget/RecyclerView;->d(I)Landroid/support/v7/widget/RecyclerView$u;
    ...
    .line 3378
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/RecyclerView;->d(I)Landroid/support/v7/widget/RecyclerView$u;
...
.method private L()V
    ...
    .line 3415
    :cond_2
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->f:Landroid/support/v7/widget/ak;
    ...
    .line 3421
    :cond_3
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView;->f:Landroid/support/v7/widget/ak;

    invoke-virtual {v2, v0}, Landroid/support/v7/widget/ak;->c(Landroid/view/View;)Z
    ...
    iget-wide v2, v0, Landroid/support/v7/widget/RecyclerView$r;->l:J
    ...
    invoke-virtual {p0, v2, v3}, Landroid/support/v7/widget/RecyclerView;->a(J)Landroid/support/v7/widget/RecyclerView$u;
    ...
    iget v0, v0, Landroid/support/v7/widget/RecyclerView$r;->m:I
...
.method private M()V
    ...
    iput-boolean v1, v2, Landroid/support/v7/widget/RecyclerView$r;->h:Z

    .line 3485
    invoke-virtual {p0}, Landroid/support/v7/widget/RecyclerView;->d()V

    .line 3486
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/dq;
    ...
    iget-boolean v3, v3, Landroid/support/v7/widget/RecyclerView$r;->i:Z
    ...
    :goto_0
    iput-boolean v0, v2, Landroid/support/v7/widget/RecyclerView$r;->g:Z
    ...
    iget-boolean v2, v2, Landroid/support/v7/widget/RecyclerView$r;->j:Z

    iput-boolean v2, v0, Landroid/support/v7/widget/RecyclerView$r;->f:Z
    ...
    iput v2, v0, Landroid/support/v7/widget/RecyclerView$r;->d:I
    ...
    iget-object v5, p0, Landroid/support/v7/widget/RecyclerView;->A:Landroid/support/v7/widget/RecyclerView$r;

    .line 3506
    invoke-static {v3}, Landroid/support/v7/widget/RecyclerView$e;->e(Landroid/support/v7/widget/RecyclerView$u;)I

    move-result v6

    .line 3507
    invoke-virtual {v3}, Landroid/support/v7/widget/RecyclerView$u;->u()Ljava/util/List;
    ...
    .line 3508
    iget-object v5, p0, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/dq;

    invoke-virtual {v5, v3, v4}, Landroid/support/v7/widget/dq;->a(Landroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$e$c;)V
    ...
    .line 3519
    iget-object v6, p0, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/dq;

    invoke-virtual {v6, v4, v5, v3}, Landroid/support/v7/widget/dq;->a(JLandroid/support/v7/widget/RecyclerView$u;)V
    ...
    iput-boolean v1, v2, Landroid/support/v7/widget/RecyclerView$r;->e:Z

    .line 3534
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView;->m:Landroid/support/v7/widget/RecyclerView$h;

    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->d:Landroid/support/v7/widget/RecyclerView$n;
    ...
    iput-boolean v0, v2, Landroid/support/v7/widget/RecyclerView$r;->e:Z
    ...
    invoke-virtual {v2}, Landroid/support/v7/widget/ak;->b()I
    ...
    invoke-virtual {v2, v3}, Landroid/support/v7/widget/dq;->d(Landroid/support/v7/widget/RecyclerView$u;)Z
    ...
    .line 3546
    invoke-virtual {v3, v4}, Landroid/support/v7/widget/RecyclerView$u;->a(I)Z
    ...
    iget-object v6, p0, Landroid/support/v7/widget/RecyclerView;->A:Landroid/support/v7/widget/RecyclerView$r;
    ...
    .line 3553
    invoke-virtual {p0, v3, v2}, Landroid/support/v7/widget/RecyclerView;->a(Landroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$e$c;)V

    goto :goto_4

    .line 3555
    :cond_7
    iget-object v4, p0, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/dq;

    invoke-virtual {v4, v3, v2}, Landroid/support/v7/widget/dq;->b(Landroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$e$c;)V
...
.method private N()V
    ...
    iput-boolean v1, v0, Landroid/support/v7/widget/RecyclerView$r;->f:Z
    ...
    :goto_0
    iput-boolean v0, v2, Landroid/support/v7/widget/RecyclerView$r;->i:Z
    ...
    iput v2, v0, Landroid/support/v7/widget/RecyclerView$r;->c:I
...
.method private O()V
    ...
    iput v11, v0, Landroid/support/v7/widget/RecyclerView$r;->c:I
    ...
    invoke-virtual {v0, v7}, Landroid/support/v7/widget/ak;->b(I)Landroid/view/View;
    ...
    .line 3616
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/dq;

    invoke-virtual {v1, v8, v9}, Landroid/support/v7/widget/dq;->a(J)Landroid/support/v7/widget/RecyclerView$u;
    ...
    .line 3628
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/dq;

    invoke-virtual {v3, v1}, Landroid/support/v7/widget/dq;->a(Landroid/support/v7/widget/RecyclerView$u;)Z
    ...
    invoke-virtual {v3, v2}, Landroid/support/v7/widget/dq;->a(Landroid/support/v7/widget/RecyclerView$u;)Z
    ...
    invoke-virtual {v1, v2, v0}, Landroid/support/v7/widget/dq;->c(Landroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$e$c;)V
    ...
    invoke-virtual {v3, v1}, Landroid/support/v7/widget/dq;->b(Landroid/support/v7/widget/RecyclerView$u;)Landroid/support/v7/widget/RecyclerView$e$c;
    ...
    invoke-virtual {v4, v2, v0}, Landroid/support/v7/widget/dq;->c(Landroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$e$c;)V

    .line 3639
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/dq;

    invoke-virtual {v0, v2}, Landroid/support/v7/widget/dq;->c(Landroid/support/v7/widget/RecyclerView$u;)Landroid/support/v7/widget/RecyclerView$e$c;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->aD:Landroid/support/v7/widget/dq$b;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/dq;->a(Landroid/support/v7/widget/dq$b;)V

    .line 3656
    :cond_5
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->m:Landroid/support/v7/widget/RecyclerView$h;

    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->d:Landroid/support/v7/widget/RecyclerView$n;
    ...
    iget v1, v1, Landroid/support/v7/widget/RecyclerView$r;->d:I

    iput v1, v0, Landroid/support/v7/widget/RecyclerView$r;->a:I
    ...
    iput-boolean v10, v0, Landroid/support/v7/widget/RecyclerView$r;->i:Z

    .line 3661
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->A:Landroid/support/v7/widget/RecyclerView$r;

    iput-boolean v10, v0, Landroid/support/v7/widget/RecyclerView$r;->j:Z
    ...
    .line 3663
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->d:Landroid/support/v7/widget/RecyclerView$n;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/RecyclerView$h;->a(Landroid/support/v7/widget/RecyclerView$r;)V
...
.method private a(FFFF)V
    ...
    .line 2120
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView;->ad:Landroid/support/v4/widget/EdgeEffectCompat;
    ...
    .line 2113
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView;->ae:Landroid/support/v4/widget/EdgeEffectCompat;
    ...
    .line 2125
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView;->af:Landroid/support/v4/widget/EdgeEffectCompat;
...
.method private a(Landroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$e$c;Landroid/support/v7/widget/RecyclerView$e$c;ZZ)V
    ...
    .line 3823
    invoke-direct {p0, p1}, Landroid/support/v7/widget/RecyclerView;->e(Landroid/support/v7/widget/RecyclerView$u;)V
    ...
    .line 3827
    invoke-direct {p0, p2}, Landroid/support/v7/widget/RecyclerView;->e(Landroid/support/v7/widget/RecyclerView$u;)V

    .line 3829
    :cond_1
    iput-object p2, p1, Landroid/support/v7/widget/RecyclerView$u;->h:Landroid/support/v7/widget/RecyclerView$u;
    ...
    .line 3834
    iput-object p1, p2, Landroid/support/v7/widget/RecyclerView$u;->i:Landroid/support/v7/widget/RecyclerView$u;
...
.method private a([I)V
    ...
    invoke-virtual {v1, v3}, Landroid/support/v7/widget/ak;->b(I)Landroid/view/View;
...
.method private a(Landroid/view/MotionEvent;)Z
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->R:Landroid/support/v7/widget/RecyclerView$k;
...
.method private b(Landroid/view/MotionEvent;)Z
    ...
    .line 2638
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->R:Landroid/support/v7/widget/RecyclerView$k;
    ...
    .line 2641
    iput-object v4, p0, Landroid/support/v7/widget/RecyclerView;->R:Landroid/support/v7/widget/RecyclerView$k;
    ...
    .line 2643
    :cond_1
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView;->R:Landroid/support/v7/widget/RecyclerView$k;
...
.method static c(Landroid/support/v7/widget/RecyclerView$u;)V
    .locals 3
    ...
    .line 5176
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView$u;->b:Ljava/lang/ref/WeakReference;
    ...
    .line 5179
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView$u;->a:Landroid/view/View;
    ...
    .line 5190
    :cond_3
    iput-object v1, p0, Landroid/support/v7/widget/RecyclerView$u;->b:Ljava/lang/ref/WeakReference;
...
.method static e(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView$u;
    .locals 1
...
.method private e(Landroid/support/v7/widget/RecyclerView$u;)V
    ...
    invoke-virtual {p0, v2}, Landroid/support/v7/widget/RecyclerView;->b(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView$u;

    move-result-object v4

    invoke-virtual {v3, v4}, Landroid/support/v7/widget/RecyclerView$n;->c(Landroid/support/v7/widget/RecyclerView$u;)V
    ...
    invoke-virtual {v0, v2, v3, v4, v1}, Landroid/support/v7/widget/ak;->a(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;Z)V
    ...
    invoke-virtual {v0, v2, v1}, Landroid/support/v7/widget/ak;->a(Landroid/view/View;Z)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/ak;->d(Landroid/view/View;)V
...
.method static l(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView;
    ...
    .line 5164
    invoke-static {v1}, Landroid/support/v7/widget/RecyclerView;->l(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView;
...
.method private z()V
    ...
    invoke-direct {v1, p0}, Landroid/support/v7/widget/bs;-><init>(Landroid/support/v7/widget/RecyclerView;)V

    invoke-direct {v0, v1}, Landroid/support/v7/widget/ak;-><init>(Landroid/support/v7/widget/ak$b;)V

    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->f:Landroid/support/v7/widget/ak;
...
.method a(IZ)Landroid/support/v7/widget/RecyclerView$u;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ak;->c()I
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/widget/ak;->d(I)Landroid/view/View;
    ...
    .line 4400
    iget v4, v1, Landroid/support/v7/widget/RecyclerView$u;->c:I
    ...
    invoke-virtual {v0, v4}, Landroid/support/v7/widget/ak;->c(Landroid/view/View;)Z
...
.method public a(J)Landroid/support/v7/widget/RecyclerView$u;
    ...
    invoke-virtual {v1}, Landroid/support/v7/widget/ak;->c()I
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/ak;->d(I)Landroid/view/View;
    ...
    invoke-virtual {v1, v4}, Landroid/support/v7/widget/ak;->c(Landroid/view/View;)Z
...
.method a()V
    ...
    new-instance v1, Landroid/support/v7/widget/bt;

    invoke-direct {v1, p0}, Landroid/support/v7/widget/bt;-><init>(Landroid/support/v7/widget/RecyclerView;)V

    invoke-direct {v0, v1}, Landroid/support/v7/widget/n;-><init>(Landroid/support/v7/widget/n$a;)V

    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->e:Landroid/support/v7/widget/n;
...
.method public a(IILandroid/view/animation/Interpolator;)V
    ...
    .line 2004
    :cond_3
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->x:Landroid/support/v7/widget/RecyclerView$t;

    invoke-virtual {v1, p1, v0, p3}, Landroid/support/v7/widget/RecyclerView$t;->a(IILandroid/view/animation/Interpolator;)V
...
.method a(IILjava/lang/Object;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ak;->d(I)Landroid/view/View;
...
.method a(IIZ)V
    ...
    invoke-virtual {v3, v0}, Landroid/support/v7/widget/ak;->d(I)Landroid/view/View;
    ...
    iput-boolean v6, v3, Landroid/support/v7/widget/RecyclerView$r;->e:Z
    ...
    invoke-virtual {v0, p1, p2, p3}, Landroid/support/v7/widget/RecyclerView$n;->a(IIZ)V
...
.method a(Landroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$e$c;)V
    ...
    invoke-virtual {p1}, Landroid/support/v7/widget/RecyclerView$u;->x()Z
    ...
    invoke-virtual {v2, v0, v1, p1}, Landroid/support/v7/widget/dq;->a(JLandroid/support/v7/widget/RecyclerView$u;)V

    .line 3743
    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/dq;

    invoke-virtual {v0, p1, p2}, Landroid/support/v7/widget/dq;->a(Landroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$e$c;)V

    .line 3744
    return-void
.end method

.method a(Landroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$e$c;Landroid/support/v7/widget/RecyclerView$e$c;)V
    .locals 1
...
.method a(Landroid/support/v7/widget/RecyclerView$u;I)Z
    .locals 1
    ...
    .line 10687
    iput p2, p1, Landroid/support/v7/widget/RecyclerView$u;->l:I
...
.method a(Landroid/view/View;)Z
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/ak;->f(Landroid/view/View;)Z
    ...
    invoke-virtual {v2, v0}, Landroid/support/v7/widget/RecyclerView$n;->c(Landroid/support/v7/widget/RecyclerView$u;)V
...
.method b(Landroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$e$c;Landroid/support/v7/widget/RecyclerView$e$c;)V
    .locals 1
...
.method public b(II)Z
    ...
    .line 2049
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->ao:Landroid/support/v7/widget/RecyclerView$j;

    if-eqz v3, :cond_9

    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->ao:Landroid/support/v7/widget/RecyclerView$j;

    invoke-virtual {v3, p1, p2}, Landroid/support/v7/widget/RecyclerView$j;->a(II)Z
    ...
    .line 2056
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->x:Landroid/support/v7/widget/RecyclerView$t;
...
.method b(Landroid/support/v7/widget/RecyclerView$u;)Z
    .locals 2
...
.method public computeVerticalScrollRange()I
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/RecyclerView$h;->h(Landroid/support/v7/widget/RecyclerView$r;)I
...
.method d(Landroid/support/v7/widget/RecyclerView$u;)I
    .locals 2
    ...
    iget v1, p1, Landroid/support/v7/widget/RecyclerView$u;->c:I

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/n;->c(I)I
...
.method public d(I)Landroid/support/v7/widget/RecyclerView$u;
    .locals 5
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/RecyclerView;->d(Landroid/support/v7/widget/RecyclerView$u;)I
...
.method public d(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView$u;
    .locals 1
    ...
    :cond_0
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/RecyclerView;->b(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView$u;
...
.method d(II)V
    ...
    .line 2176
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->ad:Landroid/support/v4/widget/EdgeEffectCompat;
    ...
    .line 2171
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->ae:Landroid/support/v4/widget/EdgeEffectCompat;
    ...
    .line 2179
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->af:Landroid/support/v4/widget/EdgeEffectCompat;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 3886
    :goto_3
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->ad:Landroid/support/v4/widget/EdgeEffectCompat;
    ...
    .line 3894
    :cond_2
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->ae:Landroid/support/v4/widget/EdgeEffectCompat;
    ...
    .line 3903
    :cond_3
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->af:Landroid/support/v4/widget/EdgeEffectCompat;
    ...
    .line 3911
    :goto_7
    iget-object v4, p0, Landroid/support/v7/widget/RecyclerView;->af:Landroid/support/v4/widget/EdgeEffectCompat;
...
.method f(II)V
    ...
    .line 4018
    iget-object v7, p0, Landroid/support/v7/widget/RecyclerView;->f:Landroid/support/v7/widget/ak;

    invoke-virtual {v7, v4}, Landroid/support/v7/widget/ak;->d(I)Landroid/view/View;

    move-result-object v7

    invoke-static {v7}, Landroid/support/v7/widget/RecyclerView;->e(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView$u;
    ...
    iget v8, v7, Landroid/support/v7/widget/RecyclerView$u;->c:I
    ...
    .line 4032
    :goto_3
    iget-object v7, p0, Landroid/support/v7/widget/RecyclerView;->A:Landroid/support/v7/widget/RecyclerView$r;

    iput-boolean v1, v7, Landroid/support/v7/widget/RecyclerView$r;->e:Z
...
.method public focusSearch(Landroid/view/View;I)Landroid/view/View;
    ...
    invoke-virtual {v0, p1, p2, v1, v3}, Landroid/support/v7/widget/RecyclerView$h;->a(Landroid/view/View;ILandroid/support/v7/widget/RecyclerView$n;Landroid/support/v7/widget/RecyclerView$r;)Landroid/view/View;
...
.method g()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->ae:Landroid/support/v4/widget/EdgeEffectCompat;
...
.method g(II)V
    ...
    iput-boolean v4, v3, Landroid/support/v7/widget/RecyclerView$r;->e:Z
...
.method public getCompatAccessibilityDelegate()Landroid/support/v7/widget/bx;
    .locals 1

    .prologue
    .line 620
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->E:Landroid/support/v7/widget/bx;
...
.method public getOnFlingListener()Landroid/support/v7/widget/RecyclerView$j;
    ...
    .prologue
    .line 1213
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->ao:Landroid/support/v7/widget/RecyclerView$j;
...
.method h()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->ad:Landroid/support/v4/widget/EdgeEffectCompat;
...
.method i()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->af:Landroid/support/v4/widget/EdgeEffectCompat;
...
.method protected onAttachedToWindow()V
    ...
    .line 2496
    sget-object v0, Landroid/support/v7/widget/bb;->a:Ljava/lang/ThreadLocal;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->y:Landroid/support/v7/widget/bb;

    .line 2497
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->y:Landroid/support/v7/widget/bb;
    ...
    .line 2510
    :goto_1
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->y:Landroid/support/v7/widget/bb;
    ...
    iput-wide v2, v1, Landroid/support/v7/widget/bb;->d:J
    ...
    invoke-virtual {v0, p0}, Landroid/support/v7/widget/bb;->a(Landroid/support/v7/widget/RecyclerView;)V
...
.method protected onDetachedFromWindow()V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/dq;->b()V
    ...
    invoke-virtual {v0, p0}, Landroid/support/v7/widget/bb;->b(Landroid/support/v7/widget/RecyclerView;)V
...
.method protected onMeasure(II)V
    ...
    iput-boolean v1, v0, Landroid/support/v7/widget/RecyclerView$r;->h:Z
    ...
    iput-boolean v1, v2, Landroid/support/v7/widget/RecyclerView$r;->f:Z
    ...
    iput-boolean v0, v1, Landroid/support/v7/widget/RecyclerView$r;->f:Z

    goto/16 :goto_0

    .line 3057
    :cond_7
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->e:Landroid/support/v7/widget/n;

    invoke-virtual {v1}, Landroid/support/v7/widget/n;->e()V
    ...
    iput v0, v1, Landroid/support/v7/widget/RecyclerView$r;->d:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 2889
    :cond_c
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView;->y:Landroid/support/v7/widget/bb;
    ...
    invoke-virtual {v2, p0, v1, v0}, Landroid/support/v7/widget/bb;->a(Landroid/support/v7/widget/RecyclerView;II)V
...
.method q()V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/RecyclerView$n;->k()V
...
.method r()V
    ...
    invoke-virtual {v2, v0}, Landroid/support/v7/widget/ak;->d(I)Landroid/view/View;
...
.method protected removeDetachedView(Landroid/view/View;Z)V
    ...
    .line 3783
    invoke-virtual {v0}, Landroid/support/v7/widget/RecyclerView$u;->m()V
...
.method public requestChildFocus(Landroid/view/View;Landroid/view/View;)V
    ...
    invoke-virtual {v0, p0, v1, p1, p2}, Landroid/support/v7/widget/RecyclerView$h;->a(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$r;Landroid/view/View;Landroid/view/View;)Z
...
.method public setAccessibilityDelegateCompat(Landroid/support/v7/widget/bx;)V
    .locals 1

    .prologue
    .line 629
    iput-object p1, p0, Landroid/support/v7/widget/RecyclerView;->E:Landroid/support/v7/widget/bx;
...
.method public setOnFlingListener(Landroid/support/v7/widget/RecyclerView$j;)V
    ...
    .prologue
    .line 1203
    iput-object p1, p0, Landroid/support/v7/widget/RecyclerView;->ao:Landroid/support/v7/widget/RecyclerView$j;
...
.method public setRecyclerListener(Landroid/support/v7/widget/RecyclerView$o;)V
    ...
    .prologue
    .line 1081
    iput-object p1, p0, Landroid/support/v7/widget/RecyclerView;->n:Landroid/support/v7/widget/RecyclerView$o;
...
.method w()V
    ...
    iget-object v4, v3, Landroid/support/v7/widget/RecyclerView$u;->i:Landroid/support/v7/widget/RecyclerView$u;

    if-eqz v4, :cond_1

    .line 4913
    iget-object v3, v3, Landroid/support/v7/widget/RecyclerView$u;->i:Landroid/support/v7/widget/RecyclerView$u;
...
.method x()V
    ...
    .line 10701
    :cond_1
    iget v2, v0, Landroid/support/v7/widget/RecyclerView$u;->l:I
    ...
    .line 10705
    iput v4, v0, Landroid/support/v7/widget/RecyclerView$u;->l:I
