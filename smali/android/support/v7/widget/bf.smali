...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/bf;->a:Landroid/view/animation/LinearInterpolator;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/bf;->b:Landroid/view/animation/DecelerateInterpolator;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/bf;->a(Landroid/util/DisplayMetrics;)F

    move-result v0

    iput v0, p0, Landroid/support/v7/widget/bf;->f:F
...
.method protected a(I)I
    ...
    .prologue
    .line 179
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/bf;->b(I)I
...
.method public a(Landroid/view/View;I)I
    ...
    .prologue
    .line 302
    invoke-virtual {p0}, Landroid/support/v7/widget/bf;->e()Landroid/support/v7/widget/RecyclerView$h;
    ...
    .line 312
    invoke-virtual/range {v0 .. v5}, Landroid/support/v7/widget/bf;->a(IIIII)I
...
.method protected a(IILandroid/support/v7/widget/RecyclerView$r;Landroid/support/v7/widget/RecyclerView$q$a;)V
    ...
    .prologue
    .line 126
    invoke-virtual {p0}, Landroid/support/v7/widget/bf;->j()I
    ...
    .line 127
    invoke-virtual {p0}, Landroid/support/v7/widget/bf;->f()V
    ...
    invoke-direct {p0, v0, p1}, Landroid/support/v7/widget/bf;->a(II)I
    ...
    invoke-direct {p0, v0, p2}, Landroid/support/v7/widget/bf;->a(II)I
    ...
    .line 140
    invoke-virtual {p0, p4}, Landroid/support/v7/widget/bf;->a(Landroid/support/v7/widget/RecyclerView$q$a;)V
...
.method protected a(Landroid/support/v7/widget/RecyclerView$q$a;)V
    ...
    .line 232
    invoke-virtual {p0}, Landroid/support/v7/widget/bf;->i()I

    move-result v0

    invoke-virtual {p0, v0}, Landroid/support/v7/widget/bf;->c(I)Landroid/graphics/PointF;
    ...
    .line 239
    :cond_1
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/bf;->a(Landroid/graphics/PointF;)V

    .line 240
    iput-object v0, p0, Landroid/support/v7/widget/bf;->c:Landroid/graphics/PointF;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/bf;->b(I)I
    ...
    iget-object v3, p0, Landroid/support/v7/widget/bf;->a:Landroid/view/animation/LinearInterpolator;
...
.method protected a(Landroid/view/View;Landroid/support/v7/widget/RecyclerView$r;Landroid/support/v7/widget/RecyclerView$q$a;)V
    ...
    .prologue
    .line 112
    invoke-virtual {p0}, Landroid/support/v7/widget/bf;->c()I

    move-result v0

    invoke-virtual {p0, p1, v0}, Landroid/support/v7/widget/bf;->b(Landroid/view/View;I)I
    ...
    invoke-virtual {p0, p1, v1}, Landroid/support/v7/widget/bf;->a(Landroid/view/View;I)I
    ...
    .line 115
    invoke-virtual {p0, v2}, Landroid/support/v7/widget/bf;->a(I)I
    ...
    iget-object v3, p0, Landroid/support/v7/widget/bf;->b:Landroid/view/animation/DecelerateInterpolator;
...
.method protected b(I)I
    ...
    iget v1, p0, Landroid/support/v7/widget/bf;->f:F
...
.method protected c()I
    ...
    .line 206
    iget-object v0, p0, Landroid/support/v7/widget/bf;->c:Landroid/graphics/PointF;
...
.method public c(I)Landroid/graphics/PointF;
    ...
    .line 355
    invoke-interface {v0, p1}, Landroid/support/v7/widget/RecyclerView$q$b;->d(I)Landroid/graphics/PointF;
