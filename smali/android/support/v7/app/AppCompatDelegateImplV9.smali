...
.field private L:Landroid/support/v7/app/ad;
...
.field private w:Landroid/support/v7/app/AppCompatDelegateImplV9$c;
...
.method constructor <init>(Landroid/content/Context;Landroid/view/Window;Landroid/support/v7/app/k;)V
    ...
    .prologue
    .line 155
    invoke-direct {p0, p1, p2, p3}, Landroid/support/v7/app/m;-><init>(Landroid/content/Context;Landroid/view/Window;Landroid/support/v7/app/k;)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/app/t;-><init>(Landroid/support/v7/app/AppCompatDelegateImplV9;)V
...
.method private a(Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;Landroid/view/KeyEvent;)V
    ...
    iget-object v5, p1, Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;->j:Landroid/support/v7/view/menu/k;
...
.method private a(Landroid/support/v7/view/menu/k;Z)V
    .locals 6
    ...
    .line 1210
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->u:Landroid/support/v7/widget/al;

    if-eqz v0, :cond_5

    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->u:Landroid/support/v7/widget/al;

    invoke-interface {v0}, Landroid/support/v7/widget/al;->e()Z
    ...
    .line 1212
    invoke-interface {v0}, Landroid/support/v7/widget/al;->g()Z
    ...
    .line 1216
    iget-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->u:Landroid/support/v7/widget/al;

    invoke-interface {v1}, Landroid/support/v7/widget/al;->f()Z
    ...
    .line 1229
    iget-object v2, v1, Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;->j:Landroid/support/v7/view/menu/k;
    ...
    iget-object v3, v1, Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;->j:Landroid/support/v7/view/menu/k;
    ...
    .line 1231
    iget-object v1, v1, Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;->j:Landroid/support/v7/view/menu/k;
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/al;->h()Z
    ...
    invoke-interface {v1}, Landroid/support/v7/widget/al;->i()Z
...
.method private a(Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;ILandroid/view/KeyEvent;I)Z
    ...
    :cond_2
    iget-object v1, p1, Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;->j:Landroid/support/v7/view/menu/k;

    if-eqz v1, :cond_3

    .line 1604
    iget-object v0, p1, Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;->j:Landroid/support/v7/view/menu/k;

    invoke-virtual {v0, p2, p3, p4}, Landroid/support/v7/view/menu/k;->performShortcut(ILandroid/view/KeyEvent;I)Z
...
.method private b(Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;)Z
    ...
    .line 1290
    invoke-virtual {v1, p0}, Landroid/support/v7/view/menu/k;->a(Landroid/support/v7/view/menu/k$a;)V

    .line 1291
    invoke-virtual {p1, v1}, Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;->a(Landroid/support/v7/view/menu/k;)V
...
.method private b(Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;Landroid/view/KeyEvent;)Z
    ...
    iget-object v4, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->u:Landroid/support/v7/widget/al;
    ...
    invoke-interface {v4}, Landroid/support/v7/widget/al;->setMenuPrepared()V
    ...
    instance-of v4, v4, Landroid/support/v7/app/af;

    if-nez v4, :cond_12

    .line 1351
    :cond_7
    iget-object v4, p1, Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;->j:Landroid/support/v7/view/menu/k;
    ...
    invoke-interface {v4, v5, v6}, Landroid/support/v7/widget/al;->setMenu(Landroid/view/Menu;Landroid/support/v7/view/menu/s$a;)V

    .line 1367
    :cond_b
    iget-object v4, p1, Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;->j:Landroid/support/v7/view/menu/k;

    invoke-virtual {v4}, Landroid/support/v7/view/menu/k;->g()V
    ...
    .line 1370
    invoke-virtual {p1, v7}, Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;->a(Landroid/support/v7/view/menu/k;)V
    ...
    invoke-interface {v0, v7, v1}, Landroid/support/v7/widget/al;->setMenu(Landroid/view/Menu;Landroid/support/v7/view/menu/s$a;)V
    ...
    invoke-virtual {v4, v5}, Landroid/support/v7/view/menu/k;->d(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0, v3}, Landroid/support/v7/view/menu/k;->setQwertyMode(Z)V
...
.method private c(Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;)Z
    ...
    .line 1306
    :cond_1
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->w:Landroid/support/v7/app/AppCompatDelegateImplV9$c;
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/app/AppCompatDelegateImplV9$c;-><init>(Landroid/support/v7/app/AppCompatDelegateImplV9;)V

    iput-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->w:Landroid/support/v7/app/AppCompatDelegateImplV9$c;

    .line 1310
    :cond_2
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->w:Landroid/support/v7/app/AppCompatDelegateImplV9$c;

    invoke-virtual {p1, v0}, Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;->a(Landroid/support/v7/view/menu/s$a;)Landroid/support/v7/view/menu/t;
...
.method private e(ILandroid/view/KeyEvent;)Z
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/al;->f()Z
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/al;->i()Z
...
.method private w()V
    ...
    iget-object v0, v0, Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;->j:Landroid/support/v7/view/menu/k;
...
.method private x()Landroid/view/ViewGroup;
    ...
    iput-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->u:Landroid/support/v7/widget/al;
    ...
    invoke-interface {v1, v2}, Landroid/support/v7/widget/al;->setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    invoke-interface {v1, v6}, Landroid/support/v7/widget/al;->a(I)V
    ...
    invoke-interface {v1, v2}, Landroid/support/v7/widget/al;->a(I)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/app/u;-><init>(Landroid/support/v7/app/AppCompatDelegateImplV9;)V
    ...
    invoke-direct {v2, p0}, Landroid/support/v7/app/v;-><init>(Landroid/support/v7/app/AppCompatDelegateImplV9;)V

    invoke-interface {v0, v2}, Landroid/support/v7/widget/ax;->setOnFitSystemWindowsListener(Landroid/support/v7/widget/ax$a;)V
    ...
    .line 489
    :cond_e
    invoke-static {v2}, Landroid/support/v7/widget/dr;->b(Landroid/view/View;)V
...
.method a(Landroid/view/Menu;)Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;
    ...
    iget-object v4, v1, Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;->j:Landroid/support/v7/view/menu/k;
...
.method a(Landroid/support/v7/view/b$a;)Landroid/support/v7/view/b;
    ...
    .line 739
    :cond_1
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->e:Landroid/support/v7/app/k;
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/app/k;->a(Landroid/support/v7/view/b$a;)Landroid/support/v7/view/b;
    :try_end_0
    ...
    invoke-interface {v0, v1}, Landroid/support/v7/app/k;->a(Landroid/support/v7/view/b;)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/app/x;-><init>(Landroid/support/v7/app/AppCompatDelegateImplV9;)V
    ...
    invoke-direct {v1, p0}, Landroid/support/v7/app/z;-><init>(Landroid/support/v7/app/AppCompatDelegateImplV9;)V
...
.method a(ILandroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;Landroid/view/Menu;)V
    ...
    .line 1547
    iget-object p3, p2, Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;->j:Landroid/support/v7/view/menu/k;
...
.method a(ILandroid/view/Menu;)V
    ...
    .line 649
    invoke-virtual {v0, v2}, Landroid/support/v7/app/ActionBar;->e(Z)V
...
.method public a(Landroid/content/res/Configuration;)V
    ...
    .line 256
    :cond_0
    invoke-static {}, Landroid/support/v7/widget/q;->a()Landroid/support/v7/widget/q;

    move-result-object v0

    iget-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->a:Landroid/content/Context;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/q;->a(Landroid/content/Context;)V
...
.method a(Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;Z)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/app/AppCompatDelegateImplV9;->b(Landroid/support/v7/view/menu/k;)V
...
.method public a(Landroid/support/v7/view/menu/k;)V
    ...
    invoke-direct {p0, p1, v0}, Landroid/support/v7/app/AppCompatDelegateImplV9;->a(Landroid/support/v7/view/menu/k;Z)V
...
.method public a(Landroid/support/v7/view/menu/k;Landroid/view/MenuItem;)Z
    ...
    .line 677
    invoke-virtual {p1}, Landroid/support/v7/view/menu/k;->p()Landroid/support/v7/view/menu/k;
...
.method public b(Landroid/support/v7/view/b$a;)Landroid/support/v7/view/b;
    ...
    iget-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->e:Landroid/support/v7/app/k;
    ...
    invoke-interface {v1, v2}, Landroid/support/v7/app/k;->a(Landroid/support/v7/view/b;)V
...
.method public b(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    .line 1016
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->L:Landroid/support/v7/app/ad;
    ...
    invoke-direct {v0}, Landroid/support/v7/app/ad;-><init>()V

    iput-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->L:Landroid/support/v7/app/ad;
    ...
    .line 1032
    invoke-static {}, Landroid/support/v7/widget/do;->a()Z
    ...
    .line 1029
    invoke-virtual/range {v0 .. v8}, Landroid/support/v7/app/ad;->a(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;ZZZZ)Landroid/view/View;
...
.method b(Landroid/support/v7/view/menu/k;)V
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/al;->j()V
...
.method b(Ljava/lang/CharSequence;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/widget/al;->setWindowTitle(Ljava/lang/CharSequence;)V
...
.method b(ILandroid/view/Menu;)Z
    ...
    .line 666
    invoke-virtual {v1, v0}, Landroid/support/v7/app/ActionBar;->e(Z)V
...
.method f(I)V
    ...
    .line 1629
    iget-object v1, v0, Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;->j:Landroid/support/v7/view/menu/k;
    ...
    .line 1631
    iget-object v2, v0, Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;->j:Landroid/support/v7/view/menu/k;

    invoke-virtual {v2, v1}, Landroid/support/v7/view/menu/k;->c(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v1}, Landroid/support/v7/view/menu/k;->g()V

    .line 1637
    iget-object v1, v0, Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;->j:Landroid/support/v7/view/menu/k;

    invoke-virtual {v1}, Landroid/support/v7/view/menu/k;->clear()V
...
.method g(I)I
    ...
    invoke-static {v5, v1, v4}, Landroid/support/v7/widget/dr;->a(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method public g()V
    ...
    .line 319
    :cond_0
    invoke-super {p0}, Landroid/support/v7/app/m;->g()V
...
.method public l()V
    ...
    invoke-direct {v1, v0, v2}, Landroid/support/v7/app/ai;-><init>(Landroid/app/Activity;Z)V
    ...
    invoke-direct {v1, v0}, Landroid/support/v7/app/ai;-><init>(Landroid/app/Dialog;)V
