...
.method constructor <init>(Landroid/support/v7/app/AlertController$a;Landroid/content/Context;Landroid/database/Cursor;ZLandroid/support/v7/app/AlertController$RecycleListView;Landroid/support/v7/app/AlertController;)V
    ...
    .prologue
    .line 986
    iput-object p1, p0, Landroid/support/v7/app/g;->c:Landroid/support/v7/app/AlertController$a;

    iput-object p5, p0, Landroid/support/v7/app/g;->a:Landroid/support/v7/app/AlertController$RecycleListView;

    iput-object p6, p0, Landroid/support/v7/app/g;->b:Landroid/support/v7/app/AlertController;

    invoke-direct {p0, p2, p3, p4}, Landroid/widget/CursorAdapter;-><init>(Landroid/content/Context;Landroid/database/Cursor;Z)V

    .line 991
    invoke-virtual {p0}, Landroid/support/v7/app/g;->getCursor()Landroid/database/Cursor;

    move-result-object v0

    .line 992
    iget-object v1, p0, Landroid/support/v7/app/g;->c:Landroid/support/v7/app/AlertController$a;
    ...
    iput v1, p0, Landroid/support/v7/app/g;->d:I
...
.method public bindView(Landroid/view/View;Landroid/content/Context;Landroid/database/Cursor;)V
    ...
    .line 1000
    iget v2, p0, Landroid/support/v7/app/g;->d:I
    ...
    .line 1001
    iget-object v2, p0, Landroid/support/v7/app/g;->a:Landroid/support/v7/app/AlertController$RecycleListView;
...
.method public newView(Landroid/content/Context;Landroid/database/Cursor;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .prologue
    .line 1007
    iget-object v0, p0, Landroid/support/v7/app/g;->c:Landroid/support/v7/app/AlertController$a;

    iget-object v0, v0, Landroid/support/v7/app/AlertController$a;->b:Landroid/view/LayoutInflater;

    iget-object v1, p0, Landroid/support/v7/app/g;->b:Landroid/support/v7/app/AlertController;
