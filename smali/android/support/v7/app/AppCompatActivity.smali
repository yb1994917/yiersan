...
.implements Landroid/support/v7/app/k;
...
# instance fields
.field private a:Landroid/support/v7/app/l;
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 1
    invoke-static {}, Landroid/support/v7/app/AppCompatActivity;->e()V
...
.method private static e()V
    ...
    const-string/jumbo v1, "AppCompatActivity.java"
    ...
    const-string/jumbo v4, "int:android.view.MenuItem"

    const-string/jumbo v5, "featureId:item"
    ...
    sput-object v0, Landroid/support/v7/app/AppCompatActivity;->e:Lorg/aspectj/lang/a$a;
...
.method public a()Landroid/support/v7/app/ActionBar;
    ...
    .prologue
    .line 110
    invoke-virtual {p0}, Landroid/support/v7/app/AppCompatActivity;->d()Landroid/support/v7/app/l;

    move-result-object v0

    invoke-virtual {v0}, Landroid/support/v7/app/l;->a()Landroid/support/v7/app/ActionBar;
...
.method public addContentView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v7/app/l;->b(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
...
.method public d()Landroid/support/v7/app/l;
    .locals 1

    .prologue
    .line 518
    iget-object v0, p0, Landroid/support/v7/app/AppCompatActivity;->a:Landroid/support/v7/app/l;

    if-nez v0, :cond_0

    .line 519
    invoke-static {p0, p0}, Landroid/support/v7/app/l;->a(Landroid/app/Activity;Landroid/support/v7/app/k;)Landroid/support/v7/app/l;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/app/AppCompatActivity;->a:Landroid/support/v7/app/l;
...
.method public findViewById(I)Landroid/view/View;
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/app/l;->a(I)Landroid/view/View;
...
.method public getMenuInflater()Landroid/view/MenuInflater;
    ...
    invoke-virtual {v0}, Landroid/support/v7/app/l;->b()Landroid/view/MenuInflater;
...
.method public getResources()Landroid/content/res/Resources;
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/do;-><init>(Landroid/content/Context;Landroid/content/res/Resources;)V
...
.method public invalidateOptionsMenu()V
    ...
    invoke-virtual {v0}, Landroid/support/v7/app/l;->f()V
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/app/l;->a(Landroid/content/res/Configuration;)V
...
.method public onContentChanged()V
    ...
    .prologue
    .line 469
    invoke-virtual {p0}, Landroid/support/v7/app/AppCompatActivity;->c()V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 72
    invoke-virtual {v0}, Landroid/support/v7/app/l;->h()V

    .line 73
    invoke-virtual {v0, p1}, Landroid/support/v7/app/l;->a(Landroid/os/Bundle;)V

    .line 74
    invoke-virtual {v0}, Landroid/support/v7/app/l;->i()Z
...
.method protected onDestroy()V
    ...
    invoke-virtual {v0}, Landroid/support/v7/app/l;->g()V
...
.method public final onMenuItemSelected(ILandroid/view/MenuItem;)Z
    ...
    .prologue
    sget-object v0, Landroid/support/v7/app/AppCompatActivity;->e:Lorg/aspectj/lang/a$a;

    invoke-static {p1}, Lorg/aspectj/a/a/b;->a(I)Ljava/lang/Object;

    move-result-object v1

    invoke-static {v0, p0, p0, v1, p2}, Lorg/aspectj/a/b/b;->a(Lorg/aspectj/lang/a$a;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Lorg/aspectj/lang/a;
    ...
    .line 204
    :goto_0
    invoke-static {}, Lcom/sensorsdata/analytics/android/sdk/aop/MenuItemSelectedAspectj;->aspectOf()Lcom/sensorsdata/analytics/android/sdk/aop/MenuItemSelectedAspectj;

    move-result-object v2

    invoke-virtual {v2, v1}, Lcom/sensorsdata/analytics/android/sdk/aop/MenuItemSelectedAspectj;->onMenuItemSelectedAOP(Lorg/aspectj/lang/a;)V
    ...
    .line 202
    invoke-virtual {p0}, Landroid/support/v7/app/AppCompatActivity;->b()Z
    :try_end_1
...
.method protected onPostCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/app/l;->b(Landroid/os/Bundle;)V
...
.method protected onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/app/l;->c(Landroid/os/Bundle;)V
...
.method protected onStart()V
    ...
    invoke-virtual {v0}, Landroid/support/v7/app/l;->c()V
...
.method public setContentView(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/app/l;->b(I)V
...
.method public setContentView(Landroid/view/View;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/app/l;->a(Landroid/view/View;)V
...
.method public setContentView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v7/app/l;->a(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
