...
.field private final g:Landroid/support/design/internal/h;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/NavigationView;->g:Landroid/support/design/internal/h;
    ...
    invoke-static {p1, p2, v0, p3, v1}, Landroid/support/v7/widget/dg;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/dg;
    ...
    .line 117
    invoke-virtual {v6, v0}, Landroid/support/v7/widget/dg;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v6, v0}, Landroid/support/v7/widget/dg;->g(I)Z
    ...
    invoke-virtual {v6, v0, v2}, Landroid/support/v7/widget/dg;->e(II)I
    ...
    invoke-virtual {v6, v0}, Landroid/support/v7/widget/dg;->e(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v6, v1, v2}, Landroid/support/v7/widget/dg;->g(II)I
    ...
    invoke-virtual {v6, v7}, Landroid/support/v7/widget/dg;->g(I)Z
    ...
    invoke-virtual {v6, v5}, Landroid/support/v7/widget/dg;->e(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v6, v7}, Landroid/support/v7/widget/dg;->a(I)Landroid/graphics/drawable/Drawable;

    move-result-object v7

    .line 153
    iget-object v8, p0, Landroid/support/design/widget/NavigationView;->f:Landroid/support/design/internal/f;

    new-instance v9, Landroid/support/design/widget/af;

    invoke-direct {v9, p0}, Landroid/support/design/widget/af;-><init>(Landroid/support/design/widget/NavigationView;)V

    invoke-virtual {v8, v9}, Landroid/support/design/internal/f;->a(Landroid/support/v7/view/menu/k$a;)V

    .line 162
    iget-object v8, p0, Landroid/support/design/widget/NavigationView;->g:Landroid/support/design/internal/h;

    invoke-virtual {v8, v4}, Landroid/support/design/internal/h;->a(I)V

    .line 163
    iget-object v4, p0, Landroid/support/design/widget/NavigationView;->g:Landroid/support/design/internal/h;

    iget-object v8, p0, Landroid/support/design/widget/NavigationView;->f:Landroid/support/design/internal/f;

    invoke-virtual {v4, p1, v8}, Landroid/support/design/internal/h;->a(Landroid/content/Context;Landroid/support/v7/view/menu/k;)V
    ...
    .line 166
    iget-object v0, p0, Landroid/support/design/widget/NavigationView;->g:Landroid/support/design/internal/h;

    invoke-virtual {v0, v1}, Landroid/support/design/internal/h;->c(I)V
    ...
    iget-object v1, p0, Landroid/support/design/widget/NavigationView;->g:Landroid/support/design/internal/h;

    invoke-virtual {v0, v1}, Landroid/support/design/internal/f;->a(Landroid/support/v7/view/menu/s;)V

    .line 171
    iget-object v0, p0, Landroid/support/design/widget/NavigationView;->g:Landroid/support/design/internal/h;

    invoke-virtual {v0, p0}, Landroid/support/design/internal/h;->a(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/t;
    ...
    invoke-virtual {v6, v0, v2}, Landroid/support/v7/widget/dg;->g(II)I
...
.method protected a(Landroid/support/v4/view/WindowInsetsCompat;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/internal/h;->a(Landroid/support/v4/view/WindowInsetsCompat;)V
...
.method public setCheckedItem(I)V
    ...
    invoke-virtual {v1, v0}, Landroid/support/design/internal/h;->a(Landroid/support/v7/view/menu/m;)V
...
.method public setItemTextAppearance(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/internal/h;->c(I)V
