...
.field private k:Landroid/support/v7/widget/r;

.field private l:Landroid/support/design/widget/ab;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v1, v2}, Landroid/support/design/widget/bt;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/widget/r;-><init>(Landroid/widget/ImageView;)V

    iput-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->k:Landroid/support/v7/widget/r;

    .line 177
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->k:Landroid/support/v7/widget/r;
    ...
    .line 181
    invoke-direct {p0}, Landroid/support/design/widget/FloatingActionButton;->getImpl()Landroid/support/design/widget/ab;
    ...
    invoke-virtual {v0, v3, v4, v5, v6}, Landroid/support/design/widget/ab;->a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;II)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/design/widget/ab;->a(F)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/design/widget/ab;->b(F)V
...
.method private a(Landroid/support/design/widget/FloatingActionButton$a;)Landroid/support/design/widget/ab$a;
    .locals 1
    ...
    invoke-direct {v0, p0, p1}, Landroid/support/design/widget/u;-><init>(Landroid/support/design/widget/FloatingActionButton;Landroid/support/design/widget/FloatingActionButton$a;)V

    goto :goto_0
.end method

.method private a()Landroid/support/design/widget/ab;
    .locals 3
    ...
    sget-object v2, Landroid/support/design/widget/bt;->a:Landroid/support/design/widget/bi$d;

    invoke-direct {v0, p0, v1, v2}, Landroid/support/design/widget/ad;-><init>(Landroid/support/design/widget/VisibilityAwareImageButton;Landroid/support/design/widget/ai;Landroid/support/design/widget/bi$d;)V
    ...
    invoke-direct {v0, p0, v1, v2}, Landroid/support/design/widget/y;-><init>(Landroid/support/design/widget/VisibilityAwareImageButton;Landroid/support/design/widget/ai;Landroid/support/design/widget/bi$d;)V
    ...
    invoke-direct {v0, p0, v1, v2}, Landroid/support/design/widget/v;-><init>(Landroid/support/design/widget/VisibilityAwareImageButton;Landroid/support/design/widget/ai;Landroid/support/design/widget/bi$d;)V
...
.method private getImpl()Landroid/support/design/widget/ab;
    .locals 1

    .prologue
    .line 788
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->l:Landroid/support/design/widget/ab;

    if-nez v0, :cond_0

    .line 789
    invoke-direct {p0}, Landroid/support/design/widget/FloatingActionButton;->a()Landroid/support/design/widget/ab;

    move-result-object v0

    iput-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->l:Landroid/support/design/widget/ab;
...
.method a(Landroid/support/design/widget/FloatingActionButton$a;Z)V
    ...
    invoke-direct {p0, p1}, Landroid/support/design/widget/FloatingActionButton;->a(Landroid/support/design/widget/FloatingActionButton$a;)Landroid/support/design/widget/ab$a;

    move-result-object v1

    invoke-virtual {v0, v1, p2}, Landroid/support/design/widget/ab;->b(Landroid/support/design/widget/ab$a;Z)V
...
.method b(Landroid/support/design/widget/FloatingActionButton$a;Z)V
    ...
    invoke-virtual {v0, v1, p2}, Landroid/support/design/widget/ab;->a(Landroid/support/design/widget/ab$a;Z)V
...
.method protected drawableStateChanged()V
    ...
    invoke-virtual {v0, v1}, Landroid/support/design/widget/ab;->a([I)V
...
.method public getCompatElevation()F
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/ab;->a()F
...
.method public getContentBackground()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/ab;->f()Landroid/graphics/drawable/Drawable;
...
.method protected onAttachedToWindow()V
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/ab;->h()V
...
.method protected onDetachedFromWindow()V
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/ab;->i()V
...
.method protected onMeasure(II)V
    ...
    invoke-virtual {v1}, Landroid/support/design/widget/ab;->g()V
...
.method public setBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/ab;->a(Landroid/content/res/ColorStateList;)V
...
.method public setBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/ab;->a(Landroid/graphics/PorterDuff$Mode;)V
...
.method public setCompatElevation(F)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/ab;->a(F)V
...
.method public setRippleColor(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/ab;->a(I)V
...
.method public setUseCompatPadding(Z)V
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/ab;->c()V
