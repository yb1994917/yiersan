...
.method constructor <init>(Landroid/support/design/widget/VisibilityAwareImageButton;Landroid/support/design/widget/ai;Landroid/support/design/widget/bi$d;)V
    ...
    .prologue
    .line 32
    invoke-direct {p0, p1, p2, p3}, Landroid/support/design/widget/v;-><init>(Landroid/support/design/widget/VisibilityAwareImageButton;Landroid/support/design/widget/ai;Landroid/support/design/widget/bi$d;)V

    .line 33
    iget-object v0, p0, Landroid/support/design/widget/y;->n:Landroid/support/design/widget/VisibilityAwareImageButton;

    invoke-virtual {v0}, Landroid/support/design/widget/VisibilityAwareImageButton;->getRotation()F

    move-result v0

    iput v0, p0, Landroid/support/design/widget/y;->q:F
...
.method private o()V
    ...
    .line 161
    iget v0, p0, Landroid/support/design/widget/y;->q:F
    ...
    :cond_0
    :goto_0
    iget-object v0, p0, Landroid/support/design/widget/y;->a:Landroid/support/design/widget/ah;
    ...
    iget v1, p0, Landroid/support/design/widget/y;->q:F

    neg-float v1, v1

    invoke-virtual {v0, v1}, Landroid/support/design/widget/ah;->a(F)V

    .line 176
    :cond_1
    iget-object v0, p0, Landroid/support/design/widget/y;->f:Landroid/support/design/widget/l;
...
.method a(Landroid/support/design/widget/ab$a;Z)V
    ...
    .line 52
    invoke-virtual {p0}, Landroid/support/design/widget/y;->m()Z
    ...
    .line 59
    invoke-direct {p0}, Landroid/support/design/widget/y;->n()Z
    ...
    invoke-direct {v1, p0, p2, p1}, Landroid/support/design/widget/z;-><init>(Landroid/support/design/widget/y;ZLandroid/support/design/widget/ab$a;)V
    ...
    .line 98
    invoke-interface {p1}, Landroid/support/design/widget/ab$a;->b()V
...
.method b(Landroid/support/design/widget/ab$a;Z)V
    ...
    .line 105
    invoke-virtual {p0}, Landroid/support/design/widget/y;->l()Z
    ...
    invoke-direct {v1, p0, p2, p1}, Landroid/support/design/widget/aa;-><init>(Landroid/support/design/widget/y;ZLandroid/support/design/widget/ab$a;)V
    ...
    .line 148
    invoke-interface {p1}, Landroid/support/design/widget/ab$a;->a()V
...
.method e()V
    ...
    .line 46
    invoke-direct {p0}, Landroid/support/design/widget/y;->o()V
