.class public Lcom/sensorsdata/analytics/android/sdk/java_websocket/drafts/Draft_76;
.super Lcom/sensorsdata/analytics/android/sdk/java_websocket/drafts/Draft_75;
.source "SourceFile"
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/sensorsdata/analytics/android/sdk/java_websocket/drafts/Draft_76;->closehandshake:[B
...
.method public constructor <init>()V
    ...
    .prologue
    .line 28
    invoke-direct {p0}, Lcom/sensorsdata/analytics/android/sdk/java_websocket/drafts/Draft_75;-><init>()V

    .line 29
    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/sensorsdata/analytics/android/sdk/java_websocket/drafts/Draft_76;->failed:Z
    ...
    iput-object v0, p0, Lcom/sensorsdata/analytics/android/sdk/java_websocket/drafts/Draft_76;->reuseableRandom:Ljava/util/Random;
...
.method public static createChallenge(Ljava/lang/String;Ljava/lang/String;[B)[B
    ...
    .line 36
    invoke-static {p0}, Lcom/sensorsdata/analytics/android/sdk/java_websocket/drafts/Draft_76;->getPart(Ljava/lang/String;)[B

    move-result-object v0

    .line 37
    invoke-static {p1}, Lcom/sensorsdata/analytics/android/sdk/java_websocket/drafts/Draft_76;->getPart(Ljava/lang/String;)[B
...
.method public acceptHandshakeAsClient(Lcom/sensorsdata/analytics/android/sdk/java_websocket/handshake/ClientHandshake;Lcom/sensorsdata/analytics/android/sdk/java_websocket/handshake/ServerHandshake;)Lcom/sensorsdata/analytics/android/sdk/java_websocket/drafts/Draft$HandshakeState;
    ...
    .prologue
    .line 109
    iget-boolean v0, p0, Lcom/sensorsdata/analytics/android/sdk/java_websocket/drafts/Draft_76;->failed:Z
    ...
    invoke-virtual {p0, p2}, Lcom/sensorsdata/analytics/android/sdk/java_websocket/drafts/Draft_76;->basicAccept(Lcom/sensorsdata/analytics/android/sdk/java_websocket/handshake/Handshakedata;)Z
    ...
    .line 117
    :cond_2
    invoke-interface {p2}, Lcom/sensorsdata/analytics/android/sdk/java_websocket/handshake/ServerHandshake;->getContent()[B
    ...
    throw v0
    :try_end_0
    .catch Lcom/sensorsdata/analytics/android/sdk/java_websocket/exceptions/InvalidHandshakeException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-interface {p1, v2}, Lcom/sensorsdata/analytics/android/sdk/java_websocket/handshake/ClientHandshake;->getFieldValue(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    invoke-interface {p1}, Lcom/sensorsdata/analytics/android/sdk/java_websocket/handshake/ClientHandshake;->getContent()[B

    move-result-object v3

    invoke-static {v1, v2, v3}, Lcom/sensorsdata/analytics/android/sdk/java_websocket/drafts/Draft_76;->createChallenge(Ljava/lang/String;Ljava/lang/String;[B)[B
    ...
    sget-object v0, Lcom/sensorsdata/analytics/android/sdk/java_websocket/drafts/Draft$HandshakeState;->NOT_MATCHED:Lcom/sensorsdata/analytics/android/sdk/java_websocket/drafts/Draft$HandshakeState;
    :try_end_1
    .catch Lcom/sensorsdata/analytics/android/sdk/java_websocket/exceptions/InvalidHandshakeException; {:try_start_1 .. :try_end_1} :catch_0
...
.method public copyInstance()Lcom/sensorsdata/analytics/android/sdk/java_websocket/drafts/Draft;
    ...
    .prologue
    .line 240
    new-instance v0, Lcom/sensorsdata/analytics/android/sdk/java_websocket/drafts/Draft_76;

    invoke-direct {v0}, Lcom/sensorsdata/analytics/android/sdk/java_websocket/drafts/Draft_76;-><init>()V
...
.method public createBinaryFrame(Lcom/sensorsdata/analytics/android/sdk/java_websocket/framing/Framedata;)Ljava/nio/ByteBuffer;
    ...
    sget-object v1, Lcom/sensorsdata/analytics/android/sdk/java_websocket/framing/Framedata$Opcode;->CLOSING:Lcom/sensorsdata/analytics/android/sdk/java_websocket/framing/Framedata$Opcode;

    if-ne v0, v1, :cond_0

    .line 229
    sget-object v0, Lcom/sensorsdata/analytics/android/sdk/java_websocket/drafts/Draft_76;->closehandshake:[B
    ...
    :cond_0
    invoke-super {p0, p1}, Lcom/sensorsdata/analytics/android/sdk/java_websocket/drafts/Draft_75;->createBinaryFrame(Lcom/sensorsdata/analytics/android/sdk/java_websocket/framing/Framedata;)Ljava/nio/ByteBuffer;
...
.method public getCloseHandshakeType()Lcom/sensorsdata/analytics/android/sdk/java_websocket/drafts/Draft$CloseHandshakeType;
    ...
    .prologue
    .line 235
    sget-object v0, Lcom/sensorsdata/analytics/android/sdk/java_websocket/drafts/Draft$CloseHandshakeType;->ONEWAY:Lcom/sensorsdata/analytics/android/sdk/java_websocket/drafts/Draft$CloseHandshakeType;
...
.method public postProcessHandshakeRequestAsClient(Lcom/sensorsdata/analytics/android/sdk/java_websocket/handshake/ClientHandshakeBuilder;)Lcom/sensorsdata/analytics/android/sdk/java_websocket/handshake/ClientHandshakeBuilder;
    ...
    invoke-static {}, Lcom/sensorsdata/analytics/android/sdk/java_websocket/drafts/Draft_76;->generateKey()Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/sensorsdata/analytics/android/sdk/java_websocket/drafts/Draft_76;->reuseableRandom:Ljava/util/Random;
    ...
    .line 150
    iget-object v1, p0, Lcom/sensorsdata/analytics/android/sdk/java_websocket/drafts/Draft_76;->reuseableRandom:Ljava/util/Random;

    invoke-virtual {v1, v0}, Ljava/util/Random;->nextBytes([B)V

    .line 151
    invoke-interface {p1, v0}, Lcom/sensorsdata/analytics/android/sdk/java_websocket/handshake/ClientHandshakeBuilder;->setContent([B)V
...
.method public postProcessHandshakeResponseAsServer(Lcom/sensorsdata/analytics/android/sdk/java_websocket/handshake/ClientHandshake;Lcom/sensorsdata/analytics/android/sdk/java_websocket/handshake/ServerHandshakeBuilder;)Lcom/sensorsdata/analytics/android/sdk/java_websocket/handshake/HandshakeBuilder;
    ...
    .line 170
    :cond_1
    invoke-static {v0, v1, v2}, Lcom/sensorsdata/analytics/android/sdk/java_websocket/drafts/Draft_76;->createChallenge(Ljava/lang/String;Ljava/lang/String;[B)[B

    move-result-object v0

    invoke-interface {p2, v0}, Lcom/sensorsdata/analytics/android/sdk/java_websocket/handshake/ServerHandshakeBuilder;->setContent([B)V
...
.method public translateFrame(Ljava/nio/ByteBuffer;)Ljava/util/List;
    ...
    .line 195
    invoke-super {p0, p1}, Lcom/sensorsdata/analytics/android/sdk/java_websocket/drafts/Draft_75;->translateRegularFrame(Ljava/nio/ByteBuffer;)Ljava/util/List;
    ...
    .line 198
    iget-object v0, p0, Lcom/sensorsdata/analytics/android/sdk/java_websocket/drafts/Draft_76;->readyframes:Ljava/util/List;

    .line 199
    const/4 v1, 0x1

    iput-boolean v1, p0, Lcom/sensorsdata/analytics/android/sdk/java_websocket/drafts/Draft_76;->readingState:Z

    .line 200
    iget-object v1, p0, Lcom/sensorsdata/analytics/android/sdk/java_websocket/drafts/Draft_76;->currentFrame:Ljava/nio/ByteBuffer;
    ...
    iput-object v1, p0, Lcom/sensorsdata/analytics/android/sdk/java_websocket/drafts/Draft_76;->currentFrame:Ljava/nio/ByteBuffer;
    ...
    iget-object v2, p0, Lcom/sensorsdata/analytics/android/sdk/java_websocket/drafts/Draft_76;->currentFrame:Ljava/nio/ByteBuffer;
    ...
    invoke-direct {v0}, Lcom/sensorsdata/analytics/android/sdk/java_websocket/exceptions/InvalidFrameException;-><init>()V
    ...
    sget-object v2, Lcom/sensorsdata/analytics/android/sdk/java_websocket/drafts/Draft_76;->closehandshake:[B
    ...
    .line 212
    new-instance v1, Lcom/sensorsdata/analytics/android/sdk/java_websocket/framing/CloseFrameBuilder;

    const/16 v2, 0x3e8

    invoke-direct {v1, v2}, Lcom/sensorsdata/analytics/android/sdk/java_websocket/framing/CloseFrameBuilder;-><init>(I)V
    ...
    iput-object v1, p0, Lcom/sensorsdata/analytics/android/sdk/java_websocket/drafts/Draft_76;->readyframes:Ljava/util/List;
...
.method public translateHandshake(Ljava/nio/ByteBuffer;)Lcom/sensorsdata/analytics/android/sdk/java_websocket/handshake/Handshakedata;
    ...
    .prologue
    .line 177
    iget-object v0, p0, Lcom/sensorsdata/analytics/android/sdk/java_websocket/drafts/Draft_76;->role:Lcom/sensorsdata/analytics/android/sdk/java_websocket/WebSocket$Role;

    invoke-static {p1, v0}, Lcom/sensorsdata/analytics/android/sdk/java_websocket/drafts/Draft_76;->translateHandshakeHttp(Ljava/nio/ByteBuffer;Lcom/sensorsdata/analytics/android/sdk/java_websocket/WebSocket$Role;)Lcom/sensorsdata/analytics/android/sdk/java_websocket/handshake/HandshakeBuilder;
    ...
    invoke-interface {v1, v0}, Lcom/sensorsdata/analytics/android/sdk/java_websocket/handshake/HandshakeBuilder;->hasFieldValue(Ljava/lang/String;)Z
    ...
    sget-object v2, Lcom/sensorsdata/analytics/android/sdk/java_websocket/WebSocket$Role;->SERVER:Lcom/sensorsdata/analytics/android/sdk/java_websocket/WebSocket$Role;
    ...
    .line 186
    invoke-interface {v1, v0}, Lcom/sensorsdata/analytics/android/sdk/java_websocket/handshake/HandshakeBuilder;->setContent([B)V
