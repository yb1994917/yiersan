...
.method private static a(Landroid/content/Context;Landroid/content/Intent;)Lcom/amap/api/location/LocationManagerBase;
    ...
    invoke-static {p0, v1}, Lcom/loc/de;->a(Landroid/content/Context;Lcom/loc/dy;)V

    invoke-static {p0}, Lcom/loc/de;->c(Landroid/content/Context;)Z

    move-result v0

    invoke-static {p0}, Lcom/loc/de;->a(Landroid/content/Context;)V

    if-eqz v0, :cond_1

    const-string/jumbo v0, "IY29tLmFtYXAuYXBpLmxvY2F0aW9uLkxvY2F0aW9uTWFuYWdlcldyYXBwZXI="

    invoke-static {v0}, Lcom/loc/dz;->c(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    const-class v3, Lcom/loc/cw;
    ...
    invoke-direct {v0, p0, p1}, Lcom/loc/cw;-><init>(Landroid/content/Context;Landroid/content/Intent;)V
