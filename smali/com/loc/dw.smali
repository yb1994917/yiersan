...
.method public static a(Landroid/content/Context;)Ljava/net/Proxy;
    ...
    invoke-static {p0, v1}, Lcom/loc/dw;->a(Landroid/content/Context;Ljava/net/URI;)Ljava/net/Proxy;
    ...
    :cond_0
    invoke-static {p0}, Lcom/loc/dw;->b(Landroid/content/Context;)Ljava/net/Proxy;
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method private static a(Landroid/content/Context;Ljava/net/URI;)Ljava/net/Proxy;
    ...
    invoke-static {p0}, Lcom/loc/dw;->c(Landroid/content/Context;)Z
...
.method private static b(Landroid/content/Context;)Ljava/net/Proxy;
    ...
    invoke-static {}, Lcom/loc/dw;->a()Ljava/lang/String;

    move-result-object v3

    invoke-static {}, Lcom/loc/dw;->b()I
    :try_end_1
    ...
    const-string/jumbo v4, "getHostProxy2"
    ...
    const-string/jumbo v5, "ghp"

    invoke-static {v0, v4, v5}, Lcom/loc/ec;->a(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V

    invoke-static {p0}, Lcom/loc/dt;->p(Landroid/content/Context;)Ljava/lang/String;
    ...
    const-string/jumbo v2, "QMTAuMC4wLjIwMA=="

    invoke-static {v2}, Lcom/loc/dz;->c(Ljava/lang/String;)Ljava/lang/String;
    :try_end_9
    ...
    const-string/jumbo v5, "getHostProxy1"
