...
.method constructor <init>(IILjava/net/Proxy;)V
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Lcom/loc/aw;-><init>(IILjava/net/Proxy;Z)V
...
.method constructor <init>(IILjava/net/Proxy;Z)V
    ...
    invoke-direct/range {v0 .. v5}, Lcom/loc/aw;-><init>(IILjava/net/Proxy;ZB)V
...
.method private constructor <init>(IILjava/net/Proxy;ZB)V
    ...
    iput-boolean v0, p0, Lcom/loc/aw;->g:Z

    const-wide/16 v0, -0x1

    iput-wide v0, p0, Lcom/loc/aw;->h:J

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lcom/loc/aw;->i:J

    new-instance v0, Lcom/loc/ax;

    invoke-direct {v0, p0}, Lcom/loc/ax;-><init>(Lcom/loc/aw;)V

    iput-object v0, p0, Lcom/loc/aw;->l:Ljavax/net/ssl/HostnameVerifier;

    iput p1, p0, Lcom/loc/aw;->b:I

    iput p2, p0, Lcom/loc/aw;->c:I

    iput-object p3, p0, Lcom/loc/aw;->f:Ljava/net/Proxy;

    iput-boolean p4, p0, Lcom/loc/aw;->d:Z

    iput-object v2, p0, Lcom/loc/aw;->k:Lcom/loc/at$a;
    ...
    iput-object v0, p0, Lcom/loc/aw;->j:Ljava/lang/String;
    :try_end_0
    ...
    iput-object v0, p0, Lcom/loc/aw;->e:Ljavax/net/ssl/SSLContext;
    :try_end_1
...
.method private a(Ljava/net/HttpURLConnection;)Lcom/loc/ba;
    .locals 10
    ...
    iget-object v5, p0, Lcom/loc/aw;->j:Ljava/lang/String;
    ...
    :cond_6
    sget-object v5, Lcom/loc/aw;->a:Lcom/loc/ay;

    if-eqz v5, :cond_7

    sget-object v5, Lcom/loc/aw;->a:Lcom/loc/ay;

    invoke-interface {v5}, Lcom/loc/ay;->a()V

    :cond_7
    new-instance v5, Lcom/loc/ba;

    invoke-direct {v5}, Lcom/loc/ba;-><init>()V

    invoke-virtual {v4}, Ljava/io/ByteArrayOutputStream;->toByteArray()[B

    move-result-object v7

    iput-object v7, v5, Lcom/loc/ba;->a:[B

    iput-object v6, v5, Lcom/loc/ba;->b:Ljava/util/Map;

    iget-object v6, p0, Lcom/loc/aw;->j:Ljava/lang/String;

    iput-object v6, v5, Lcom/loc/ba;->c:Ljava/lang/String;

    iput-object v0, v5, Lcom/loc/ba;->d:Ljava/lang/String;
    :try_end_b
    ...
    invoke-static {v4, v5, v6}, Lcom/loc/ec;->a(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v3, v4, v5}, Lcom/loc/ec;->a(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v4, v6}, Lcom/loc/ec;->a(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v3, v4}, Lcom/loc/ec;->a(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v1, v3}, Lcom/loc/ec;->a(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
...
.method private a(Ljava/lang/String;Ljava/util/Map;Z)Ljava/net/HttpURLConnection;
    ...
    iget-object v2, p0, Lcom/loc/aw;->k:Lcom/loc/at$a;

    if-eqz v2, :cond_0

    iget-object v0, p0, Lcom/loc/aw;->k:Lcom/loc/at$a;

    iget-object v2, p0, Lcom/loc/aw;->f:Ljava/net/Proxy;

    invoke-interface {v0}, Lcom/loc/at$a;->a()Ljava/net/URLConnection;
    ...
    iget-object v0, p0, Lcom/loc/aw;->f:Ljava/net/Proxy;
    ...
    :cond_1
    :goto_0
    iget-boolean v1, p0, Lcom/loc/aw;->d:Z
    ...
    iget-object v2, p0, Lcom/loc/aw;->e:Ljavax/net/ssl/SSLContext;
    ...
    iget-object v2, p0, Lcom/loc/aw;->l:Ljavax/net/ssl/HostnameVerifier;
    ...
    :cond_2
    invoke-direct {p0, p2, v0}, Lcom/loc/aw;->a(Ljava/util/Map;Ljava/net/HttpURLConnection;)V
...
.method public static a(Lcom/loc/ay;)V
    .locals 0

    sput-object p0, Lcom/loc/aw;->a:Lcom/loc/ay;
...
.method private a(Ljava/util/Map;Ljava/net/HttpURLConnection;)V
    ...
    iget-object v1, p0, Lcom/loc/aw;->j:Ljava/lang/String;
...
# virtual methods
.method final a(Ljava/lang/String;Ljava/util/Map;[B)Lcom/loc/ba;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_0
    invoke-direct {p0, p1, p2, v0}, Lcom/loc/aw;->a(Ljava/lang/String;Ljava/util/Map;Z)Ljava/net/HttpURLConnection;
    ...
    :cond_0
    invoke-direct {p0, v1}, Lcom/loc/aw;->a(Ljava/net/HttpURLConnection;)Lcom/loc/ba;
    :try_end_0
...
.method final a(Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;Lcom/loc/av$a;)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_1
    :try_start_0
    invoke-static {p3}, Lcom/loc/aw;->a(Ljava/util/Map;)Ljava/lang/String;
    ...
    invoke-direct {p0, v1, p2, v4}, Lcom/loc/aw;->a(Ljava/lang/String;Ljava/util/Map;Z)Ljava/net/HttpURLConnection;
    :try_end_0
    ...
    iget-wide v6, p0, Lcom/loc/aw;->i:J
    ...
    invoke-interface {p4}, Lcom/loc/av$a;->b()V
    ...
    iget-boolean v3, p0, Lcom/loc/aw;->g:Z
    ...
    iget-wide v4, p0, Lcom/loc/aw;->h:J
    ...
    iget-wide v4, p0, Lcom/loc/aw;->i:J

    iget-wide v6, p0, Lcom/loc/aw;->h:J
    ...
    invoke-interface {p4, v2, v4, v5}, Lcom/loc/av$a;->a([BJ)V
    ...
    iput-wide v4, p0, Lcom/loc/aw;->i:J
    :try_end_2
    ...
    invoke-interface {p4, v4, v6, v7}, Lcom/loc/av$a;->a([BJ)V
    :try_end_6
    ...
    :cond_b
    :try_start_9
    iget-boolean v2, p0, Lcom/loc/aw;->g:Z

    if-eqz v2, :cond_d

    invoke-interface {p4}, Lcom/loc/av$a;->d()V
    :try_end_9
    ...
    :cond_d
    :try_start_c
    invoke-interface {p4}, Lcom/loc/av$a;->c()V
    :try_end_c
