...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/loc/ci;->a:Ljava/util/Hashtable;

    new-instance v0, Ljava/util/Hashtable;

    invoke-direct {v0}, Ljava/util/Hashtable;-><init>()V

    iput-object v0, p0, Lcom/loc/ci;->b:Ljava/util/Hashtable;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/loc/ci;->c:Z

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/loc/ci;->d:Landroid/content/Context;
...
.method private a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;IJZ)V
    ...
    :cond_1
    iget-object v0, p0, Lcom/loc/ci;->a:Ljava/util/Hashtable;
    ...
    :goto_2
    iget-object v1, p0, Lcom/loc/ci;->a:Ljava/util/Hashtable;
    ...
    sget-boolean v0, Lcom/loc/cs;->k:Z
    ...
    invoke-static {p1, v0, v1, v5}, Lcom/loc/df;->b(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Z)Z

    move-result v0

    if-nez v0, :cond_2

    sput-boolean v6, Lcom/loc/cs;->k:Z

    const-string/jumbo v0, "pref"

    const-string/jumbo v1, "ddex"

    invoke-static {p1, v0, v1, v6}, Lcom/loc/df;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Z)V

    :cond_2
    if-eqz p7, :cond_0

    :try_start_2
    iget-object v0, p0, Lcom/loc/ci;->b:Ljava/util/Hashtable;
    ...
    :goto_3
    const-string/jumbo v3, "HeatMap"

    const-string/jumbo v4, "update1"
...
.method public final a()V
    ...
    :cond_0
    iget-object v1, p0, Lcom/loc/ci;->d:Landroid/content/Context;
    ...
    :try_start_1
    const-string/jumbo v0, "CREATE TABLE IF NOT EXISTS hm"

    invoke-virtual {v3, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v0, p0, Lcom/loc/ci;->e:Ljava/lang/String;
    ...
    invoke-static {v1}, Lcom/loc/dh;->c(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    invoke-static {v5}, Lcom/loc/dh;->c(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v5

    const-string/jumbo v6, "REPLACE INTO "
    ...
    iget-object v7, p0, Lcom/loc/ci;->e:Ljava/lang/String;
    ...
    :cond_3
    iput-boolean v10, p0, Lcom/loc/ci;->c:Z
...
.method public final a(Landroid/content/Context;)V
    ...
    sget-boolean v0, Lcom/loc/bo;->a:Z
    ...
    :cond_1
    iget-boolean v0, p0, Lcom/loc/ci;->c:Z
    ...
    :cond_2
    :goto_1
    iput-boolean v11, p0, Lcom/loc/ci;->c:Z
    ...
    invoke-static {v10, v0}, Lcom/loc/dh;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Z
    ...
    iget-object v5, p0, Lcom/loc/ci;->e:Ljava/lang/String;
    ...
    invoke-static {v3}, Lcom/loc/dh;->d(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    invoke-static {v4}, Lcom/loc/dh;->d(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct/range {v1 .. v8}, Lcom/loc/ci;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;IJZ)V
...
.method public final a(Landroid/content/Context;Ljava/lang/String;Lcom/autonavi/aps/amapapi/model/AMapLocationServer;)V
    ...
    invoke-static {v0, v1, v2, v3}, Lcom/loc/br;->a(DD)Ljava/lang/String;
