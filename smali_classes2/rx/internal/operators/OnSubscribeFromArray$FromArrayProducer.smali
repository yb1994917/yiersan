...
# direct methods
.method public constructor <init>(Lrx/m;[Ljava/lang/Object;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 47
    iput-object p1, p0, Lrx/internal/operators/OnSubscribeFromArray$FromArrayProducer;->child:Lrx/m;
...
.method fastPath()V
    ...
    .prologue
    .line 69
    iget-object v1, p0, Lrx/internal/operators/OnSubscribeFromArray$FromArrayProducer;->child:Lrx/m;
    ...
    .line 76
    :cond_1
    invoke-virtual {v1, v4}, Lrx/m;->onNext(Ljava/lang/Object;)V
...
.method slowPath(J)V
    ...
    invoke-virtual {v1, v8}, Lrx/m;->onNext(Ljava/lang/Object;)V
