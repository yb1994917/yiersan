...
.field final combiner:Lrx/functions/h;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lrx/functions/h",
            "<+TR;>;"
...
.field final queue:Lrx/internal/util/atomic/e;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public constructor <init>(Lrx/m;Lrx/functions/h;IIZ)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 116
    iput-object p1, p0, Lrx/internal/operators/OnSubscribeCombineLatest$LatestCoordinator;->actual:Lrx/m;

    .line 117
    iput-object p2, p0, Lrx/internal/operators/OnSubscribeCombineLatest$LatestCoordinator;->combiner:Lrx/functions/h;
    ...
    iput-object v0, p0, Lrx/internal/operators/OnSubscribeCombineLatest$LatestCoordinator;->queue:Lrx/internal/util/atomic/e;
...
.method checkTerminated(ZZLrx/m;Ljava/util/Queue;Z)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZ",
...
.method combine(Ljava/lang/Object;I)V
    ...
    .line 213
    iget-object v0, p0, Lrx/internal/operators/OnSubscribeCombineLatest$LatestCoordinator;->queue:Lrx/internal/util/atomic/e;
    ...
    invoke-virtual {v5, v0, v1}, Lrx/internal/operators/OnSubscribeCombineLatest$a;->b(J)V
...
.method drain()V
    ...
    .line 233
    :cond_1
    iget-object v4, p0, Lrx/internal/operators/OnSubscribeCombineLatest$LatestCoordinator;->queue:Lrx/internal/util/atomic/e;

    .line 234
    iget-object v3, p0, Lrx/internal/operators/OnSubscribeCombineLatest$LatestCoordinator;->actual:Lrx/m;
    ...
    invoke-virtual/range {v0 .. v5}, Lrx/internal/operators/OnSubscribeCombineLatest$LatestCoordinator;->checkTerminated(ZZLrx/m;Ljava/util/Queue;Z)Z
    ...
    invoke-virtual {v3, v0}, Lrx/m;->onError(Ljava/lang/Throwable;)V
    ...
    :cond_6
    :try_start_0
    iget-object v1, p0, Lrx/internal/operators/OnSubscribeCombineLatest$LatestCoordinator;->combiner:Lrx/functions/h;

    invoke-interface {v1, v0}, Lrx/functions/h;->a([Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_0
    ...
    .line 283
    invoke-virtual {v3, v0}, Lrx/m;->onNext(Ljava/lang/Object;)V

    .line 285
    const-wide/16 v0, 0x1

    invoke-virtual {v6, v0, v1}, Lrx/internal/operators/OnSubscribeCombineLatest$a;->b(J)V
...
.method public subscribe([Lrx/g;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
    ...
    .line 136
    iget-object v1, p0, Lrx/internal/operators/OnSubscribeCombineLatest$LatestCoordinator;->actual:Lrx/m;

    invoke-virtual {v1, p0}, Lrx/m;->a(Lrx/n;)V

    .line 137
    iget-object v1, p0, Lrx/internal/operators/OnSubscribeCombineLatest$LatestCoordinator;->actual:Lrx/m;

    invoke-virtual {v1, p0}, Lrx/m;->a(Lrx/i;)V
    ...
    invoke-virtual {v1, v4}, Lrx/g;->b(Lrx/m;)Lrx/n;
