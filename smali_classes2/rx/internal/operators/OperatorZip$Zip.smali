...
.field private final childSubscription:Lrx/subscriptions/c;
...
.method public constructor <init>(Lrx/m;Lrx/functions/h;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object v0, p0, Lrx/internal/operators/OperatorZip$Zip;->childSubscription:Lrx/subscriptions/c;

    .line 184
    iput-object p1, p0, Lrx/internal/operators/OperatorZip$Zip;->child:Lrx/h;

    .line 185
    iput-object p2, p0, Lrx/internal/operators/OperatorZip$Zip;->zipFunction:Lrx/functions/h;

    .line 186
    iget-object v0, p0, Lrx/internal/operators/OperatorZip$Zip;->childSubscription:Lrx/subscriptions/c;
...
# virtual methods
.method public start([Lrx/g;Ljava/util/concurrent/atomic/AtomicLong;)V
    .locals 5
    ...
    .line 195
    iget-object v4, p0, Lrx/internal/operators/OperatorZip$Zip;->childSubscription:Lrx/subscriptions/c;
    ...
    invoke-virtual {v3, v0}, Lrx/g;->a(Lrx/m;)Lrx/n;
...
.method tick()V
    ...
    .line 222
    iget-object v6, p0, Lrx/internal/operators/OperatorZip$Zip;->child:Lrx/h;
    ...
    .line 231
    invoke-virtual {v0}, Lrx/internal/util/f;->g()Ljava/lang/Object;
    ...
    .line 238
    :cond_3
    invoke-virtual {v0, v9}, Lrx/internal/util/f;->b(Ljava/lang/Object;)Z
    ...
    .line 239
    invoke-interface {v6}, Lrx/h;->onCompleted()V
    ...
    .line 245
    :cond_4
    invoke-virtual {v0, v9}, Lrx/internal/util/f;->c(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 252
    :try_start_0
    iget-object v0, p0, Lrx/internal/operators/OperatorZip$Zip;->zipFunction:Lrx/functions/h;

    invoke-interface {v0, v8}, Lrx/functions/h;->a([Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v0

    invoke-interface {v6, v0}, Lrx/h;->onNext(Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, v8}, Lrx/internal/util/f;->b(Ljava/lang/Object;)Z
    ...
    .line 257
    invoke-static {v0, v6, v8}, Lrx/exceptions/a;->a(Ljava/lang/Throwable;Lrx/h;Ljava/lang/Object;)V
